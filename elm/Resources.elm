...
pageRequest =
    GraphQl.named "query"
        [ GraphQl.field "pageBy"
            |> GraphQl.withArgument "uri" (GraphQl.string "resources")
...
openGraphTags =
    OpenGraphTags "Resources" "Resources produced by the Christian Muslim Forum" (getFeaturedImageSrc Nothing) (frontendUrl ++ "/resources")
